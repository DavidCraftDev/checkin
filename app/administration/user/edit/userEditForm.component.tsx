        ...
        <div>
            <form onSubmit={handleSubmit} className="p-2">
                <div>
                    ...
                    <input type="text" name="courses" id="courses" placeholder="Deutsch,Mathe,Englisch" defaultValue={userData.courses?.toString() || ""} disabled={true} className="rounded-full p-2 m-4 border-2 border-black-600 ring-0 ring-black-600 focus:outline-none focus:ring-1" />
                    <br className={config.use_ldap ? "hidden" : ""} />
